...
{className="float-img right optometrist-img mt-4"}![Optometrist Performing Eye Exam]({{ image1 | ../../images/what-we-do/wwd-optometrist-img.jpg }})
...
{className="float-img left volunteer-img"}![Volunteer helping patient]({{ image2 | /images/what-we-do/wwd-img-2.jpg }})
